  ...
  new SamlStrategy(
    {
      ...
      logoutUrl: "https://saml-access-management-foundation.onrender.com",
...
app.get('/profile', ensureAuthenticated, (req, res) => {
  ...
  const usr =req.user;
  res.render("pages/profile",{ title: 'Home',userdetails:usr, attr: usr["atttributes] ,usrname: usr['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name']});
});
